    ...
    foreach ($table as $row) {
      if ($row['file_format'] == "video") {
        if ($row['disapproved'] != "") {
          ...
          <td>
          <button class='btn waves-effect green darken-2 edit_video' data-edit-id='$row[file_id]'>
            Edit
          </button>
          </td>

          <td>
            <button class='btn waves-effect green darken-2 delete_video' data-delete-id='$row[file_id]'>
              Delete
            </button>
          </td>
