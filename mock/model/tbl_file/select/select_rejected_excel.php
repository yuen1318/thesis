    ...
    foreach ($table as $row) {
      if ($row['file_format'] == "excel") {
        if ($row['disapproved'] != "") {
          ...
          <td>
          <button class='btn waves-effect green darken-2 edit_excel' data-edit-id='$row[file_id]'>
            Edit
          </button>
          </td>

          <td>
            <button class='btn waves-effect green darken-2 delete_excel' data-delete-id='$row[file_id]'>
              Delete
            </button>
          </td>
