...
$allowed_ext = array("jpg");
  ...
  #if $uploaded_img_ext is in the list of $allowed_ext
  if (in_array($uploaded_img_ext, $allowed_ext) ) {
    ...
    #query to database
    $sql = "UPDATE tbl_user SET photo=? WHERE email=?";
