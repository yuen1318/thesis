<?php
 ...
 ?>
  ...
  <body class="grey lighten-3">
    ...
    <div class="row">
      <div class="fixed-action-btn vertical">
        <a href="addTemplate.php" class="btn-floating btn-large green darken-2 btn tooltipped waves-effect fa fa-plus fa-lg" data-position="left"
          data-delay="50" data-tooltip="Add template"></a>
      </div>
    </div>
  ...
  <script src="../../controller/user/manageTemplate.js" charset="utf-8"></script>
