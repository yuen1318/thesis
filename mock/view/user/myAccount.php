...
<html>
  ...
  <script type="text/javascript">
    $(document).ready(function(){
      ...
      $('#btn_frm_info').on('click', function() {//validate on btn click
       if ($("#frm_info").valid()){//check if all field is valid
        update_user_info("../../model/tbl_user/update/update_user_info.php","#frm_info");
       }
       else{
      ...
      $('#btn_frm_signature').on('click', function() {//validate on btn click
       if ($("#frm_signature").valid()){//check if all field is valid
        update_user_signature("../../model/tbl_user/update/update_user_signature.php","#frm_signature");
       }
       else{
          $('.val').addClass('animated bounceIn');
          $('.val').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
      ...
      $('#btn_frm_change_password').on('click', function() {//validate on btn click
       if ($("#frm_change_password").valid()){//check if all field is valid
         update_user_password("../../model/tbl_user/update/update_user_password.php","#frm_change_password");
       }
       else{
          $('.val').addClass('animated bounceIn');
          $('.val').one('webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend', function(){
    ...
    function update_user_info(model_url,form_name){
    $.ajax({
      url:  model_url,
      method:"POST",
  ...
  }//end of update_user_info

  function update_user_signature(model_url,form_name){
  $.ajax({
    url:  model_url,
    method:"POST",
    data: $(form_name).serialize(),
...
function update_user_password(model_url,form_name){
$.ajax({
  url:  model_url,
  method:"POST",
  data: $(form_name).serialize(),
