...
<html>
  ...
  <body class="grey lighten-3">
    ...
    <div class="row">
      ...
      <div class="col s12 m12 l12" id="list_video_tracks" ><!--Table-->
        <div class="row">
        ...
        <table class="bordered centered responsive-table striped">
          ...
          <tbody class="list" id="tbl_video_tracks"></tbody><!--end of tbody-->
        </table><!--end of table-->
...
<script src="../../controller/admin/track_video.js" charset="utf-8"></script>
