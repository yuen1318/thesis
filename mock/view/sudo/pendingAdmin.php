  ...
  <body class="grey lighten-3">
    ...
    <?php require 'nav.php'; ?><br>
        ...
        <div class="row">
          ...
          <div class="col s12 m12 l12" id="list_pending_admin" ><!--Table-->
            <div class="row">
            ...
            <table class="bordered centered responsive-table striped">
              ...
              <tbody class="list" id="tbl_pending_admin"></tbody><!--end of tbody-->
            </table><!--end of table-->
      ...
      <a href="#delete_pending_admin_modal" class="hide btn modal-trigger trgr_delete_pending_admin ">activedel</a>
      <form id="frm_delete_pending_admin">
        <div class="modal" id="delete_pending_admin_modal">
