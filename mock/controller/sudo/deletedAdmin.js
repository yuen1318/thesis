$(document).ready(function(){
        ...
        $(document).on('click', '.delete_deleted_admin', function() {
         ...
         $('#btn_delete_deleted_admin').on('click', function(event) {
          ...
          if ($("#frm_delete_deleted_admin").valid()) { //check if all field is valid
            delete_deleted_admin("../../model/tbl_admin/delete/delete_deleted_admin.php", "#frm_delete_deleted_admin");            
            $('#delete_deleted_admin_modal').modal('close');
            $('#delete_pw').val("");
        ...
        $('#btn_restore_deleted_admin').on('click', function(event) {
          if ($("#frm_restore_deleted_admin").valid()) { //check if all field is valid
            restore_deleted_admin("../../model/tbl_admin/update/restore_deleted_admin.php" , "#frm_restore_deleted_admin");       
            $('#restore_deleted_admin_modal').modal('close');
            $('#restore_pw').val("");
       ...
       $("#frm_delete_deleted_admin").validate({ //form validation
        rules: {
          delete_pw: {
            required: true,
            equalTo: "#delete_rpw"
      ...
      $("#frm_restore_deleted_admin").validate({ //form validation
        rules: {
          restore_pw: {
            required: true,
            equalTo: "#restore_rpw"
